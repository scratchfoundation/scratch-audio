...
/***/ function(module, exports, __webpack_require__) {
	...
	var StartAudioContext = __webpack_require__(15);
	...
	function AudioEngine () {
	    ...
	    this.effectsNode.chain(
	        this.roboticEffect, this.echoEffect, Tone.Master);
	    ...
	    // this.effectsNode = new Tone.Gain();
	    // log.warn('effects disabled');
	    // this.effectsNode.toMaster();

	    // load sounds

	    this.soundPlayers = [];
	    //this.loadSounds(sounds);
	    // this.loadSound('sounds/vibraphone.mp3');
	    // this.loadSound('sounds/whistle.wav');
	    // this.loadSound('https://raw.githubusercontent.com/ericrosenbaum/MK-1/gh-pages/sounds/kalimba.wav');
	    // this.loadSound('http://web.media.mit.edu/~ericr/things/sounds/meow.wav'); // does not work
	    var soundUrls = [
	...
	AudioEngine.prototype.loadSounds = function (urls) {
	    ...
	    for (var index=0; index<urls.length; index++) {
	        this.soundPlayers[index].setBuffer(new Tone.Buffer(urls[index]));
	    }
	};
	...
	AudioEngine.prototype.playNoteForBeats = function (note, beats) {
	    ...
	    // log.warn('play note');
	    // var player = new Tone.Player('sounds/piano_C3.wav').toMaster();
	...
	*/
	...
	AudioEngine.prototype.setInstrument = function (instrumentNum) {
	    var newNum = instrumentNum - 1;

	    if (newNum == this.instrumentNum) {
	        return;
	    }

	    this.instrumentNum = newNum;
